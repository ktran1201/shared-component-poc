...
export interface PrivateTextInputScssProps
  extends HTMLProps<
      'input',
      | 'name'
      | 'placeholder'
...
export const PrivateTextInputScss = React.forwardRef<HTMLInputElement, PrivateTextInputScssProps>(
  (
    {
      label = '',
      type = 'text',
...
PrivateTextInputScss.displayName = 'PrivateTextInput';
